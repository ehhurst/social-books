...
export const BookList = createContext<BookItem[] | []>([]);
BookList.displayName = 'BookListContext';

function BookListContext({children} : ContextProps, category:string) {
    ...
    return(
        <BookList.Provider value={bookList}>{children}{category}</BookList.Provider>
    )
}
