...
## copied code that changes were based on
...
def fetch_books_from_api(query=None, title=None, author=None, subject=None, limit=5):
    ...
    """
    api_url = 'https://openlibrary.org/search.json?q=test' ## the ?q=test part was added based on example
    params = {}
    ...
    params['limit'] = limit
    params['headers'] = {
        "User-Agent" : "ShelfLife/1.0 (connorb24@vt.edu)"
    }
