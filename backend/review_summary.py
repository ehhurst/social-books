...
from review_utils import return_review_data_helper
from book_api import get_book

# Configuration
endpoint = "https://models.inference.ai.azure.com"
model_name = "gpt-4.1"
token = "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" # This is for testing purposes only.
...
def review_analysis(book_id: str) -> str:
    ...
    reviews_data = return_review_data_helper(book_id)
